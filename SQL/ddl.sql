-- omservice.scene_map definition

CREATE TABLE `scene_map` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_name` varchar(120) NOT NULL,
  `scene_code` varchar(120) NOT NULL,
  `description` varchar(258) DEFAULT NULL COMMENT '描述',
  `model` varchar(128) DEFAULT NULL COMMENT '当前模型',
  ...
  `status` varchar(1) DEFAULT '1' COMMENT '1正常0停用',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `prompt_template` text DEFAULT NULL COMMENT '提示词',
  `repository` varchar(128) NOT NULL DEFAULT 'SPARK' COMMENT '知识库',
...
) AUTO_INCREMENT = 23250514 DEFAULT CHARSET = utf8mb4 ROW_FORMAT = DYNAMIC COMPRESSION = 'zstd_1.0' REPLICA_NUM = 3 BLOCK_SIZE = 16384 USE_BLOOM_FILTER = FALSE TABLET_SIZE = 134217728 PCTFREE = 0;